...
std::ostringstream LobbyServerEngine::LogManager::s_oss;
std::mutex LobbyServerEngine::LogManager::s_logMutex;

void LobbyServerEngine::LogManager::Init()
{
...
void LobbyServerEngine::LogManager::PrintLastError(const std::source_location& loc)
{
...
void LobbyServerEngine::LogManager::Save()
{
