...
enum GENERAL_STATE_TYPE : uint8_t {
  ...
  GENERAL_STATE_TYPE_DEAD = 3,
  GENERAL_STATE_TYPE_END = 4,
  GENERAL_STATE_TYPE_MIN = GENERAL_STATE_TYPE_NONE,
  GENERAL_STATE_TYPE_MAX = GENERAL_STATE_TYPE_END
};

inline const GENERAL_STATE_TYPE (&EnumValuesGENERAL_STATE_TYPE())[5] {
...
enum PLAYER_STATE_TYPE : uint8_t {
  ...
  PLAYER_STATE_TYPE_PRE_DELAY = 3,
  PLAYER_STATE_TYPE_ATTACK = 4,
  PLAYER_STATE_TYPE_POST_DELAY = 5,
  PLAYER_STATE_TYPE_DEFENSE = 6,
  PLAYER_STATE_TYPE_STUN = 7,
  PLAYER_STATE_TYPE_DEAD = 8,
  PLAYER_STATE_TYPE_END = 9,
...
enum SOLDIER_STATE_TYPE : uint8_t {
  ...
  SOLDIER_STATE_TYPE_IDLE = 1,
  SOLDIER_STATE_TYPE_MOVE = 2,
  SOLDIER_STATE_TYPE_CHASE = 3,
  SOLDIER_STATE_TYPE_ATTACK = 4,
