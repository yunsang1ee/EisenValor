...
#pragma region ROOM_PACKETS
	...
	SC_LOADING_GAME_WORLD_PKT = 1015,

	CS_COMPLETE_LOADING_GAME_WORLD_PKT = 1016,
	SC_START_GAME_FAIL_PKT = 1017,
	SC_START_GAME_SUCCESS_PKT = 1018,

	SC_CHANGE_GAME_ROOM_STATE_PKT = 1019,
#pragma endregion
