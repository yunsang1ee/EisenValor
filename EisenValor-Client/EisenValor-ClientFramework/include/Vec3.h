...
//	Vec3A() noexcept : v{DirectX::XMVectorZero()} {}
//	Vec3A(float x_, float y_, float z_) noexcept : v{DirectX::XMVectorSet(x_, y_, z_, 0.0f)} {}
//
//	[[nodiscard]]
...
//
//	[[nodiscard]]
//	constexpr explicit Vec3A(DirectX::XMVECTOR v_) noexcept
//		: v(v_)
//	{
//	}
//
//	[[nodiscard]] operator DirectX::XMFLOAT3A() const noexcept
//	{
...
//
//	[[nodiscard]] Vec3 ToVec3() const noexcept
//	{
//		Vec3 temp;
//		DirectX::XMStoreFloat3(&temp, this->v);
//		return temp;
//	}
//
...
//	Vec3A operator+(const Vec3A& rhs) const noexcept { return static_cast<Vec3A>(DirectX::XMVectorAdd(v, rhs.v)); }
//
//	[[nodiscard]]
...
//	{
//		assert(scalar != 0.0f);
//		v = DirectX::XMVectorScale(v, 1.0f / scalar);
//		return *this;
//	}
//
//	[[nodiscard]]
//	Vec3A operator-() const noexcept
//	{
//		return *this * -1.0f;
//	}
//
...
//
//	[[nodiscard]] float Length() const noexcept { return DirectX::XMVectorGetX(DirectX::XMVector3Length(v)); }
//	[[nodiscard]] Vec3A Normalize() const noexcept { return Vec3A(DirectX::XMVector3Normalize(v)); }
//	[[nodiscard]] float Dot(const Vec3A& rhs) const noexcept
//	{
//		return DirectX::XMVectorGetX(DirectX::XMVector3Dot(v, rhs.v));
//	}
//	[[nodiscard]] Vec3A Cross(const Vec3A& rhs) const noexcept { return Vec3A(DirectX::XMVector3Cross(v, rhs.v)); }
//#pragma endregion
//
//#pragma region Static
//	[[nodiscard]] static Vec3A Zero() noexcept { return Vec3A(DirectX::XMVectorZero()); }
//	[[nodiscard]] static Vec3A One() noexcept { return Vec3A{1.0f, 1.0f, 1.0f}; }
//	[[nodiscard]] static Vec3A Right() noexcept { return Vec3A{1.0f, 0.0f, 0.0f}; }
//	[[nodiscard]] static Vec3A Up() noexcept { return Vec3A{0.0f, 1.0f, 0.0f}; }
//	[[nodiscard]] static Vec3A Forward() noexcept { return Vec3A{0.0f, 0.0f, 1.0f}; }
//#pragma endregion
//};