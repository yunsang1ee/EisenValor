...
#pragma region OnEvent
	...
	inline void OnWheelScroll(int delta) noexcept final {
		m_MouseState.wheelDelta = static_cast<float>(delta);
	}
#pragma endregion
...
#pragma region Getter
	...
	[[nodiscard]] inline int GetWheelScroll() const noexcept final {
		return static_cast<int>(m_MouseState.wheelDelta);
	}
