...
#pragma region LOBBY_PACKETS
	...
	SC_ENTER_GAME_LOBBY_SUCCESS_PKT = 101,

	SC_ENTER_GAME_LOBBY_FAIL_PKT = 102,

	CS_LEAVE_GAME_LOBBY_PKT = 103,
	SC_LEAVE_GAME_LOBBY_PKT = 104, // To me

	SC_ENTER_USER_IN_GAME_LOBBY_PKT = 105,
	SC_LEAVE_USER_IN_GAME_LOBBY_PKT = 106,

	CS_MAKE_GAME_ROOM_PKT = 107,
	SC_MAKE_GAME_ROOM_PKT = 108,
#pragma endregion
...
#pragma region ROOM_PACKETS
	CS_ENTER_GAME_ROOM_PKT = 1000,
	SC_ENTER_GAME_ROOM_FAIL_PKT = 1001,	   // To me
	SC_ENTER_GAME_ROOM_SUCCESS_PKT = 1002, // To me
	...
	LS_CREATE_GAME_WORLD_PKT = 1014,
	SL_CREATE_GAME_WORLD_PKT = 1015,

	LC_CONNECT_TO_GAME_SERVER_PKT = 1016,

	SC_LOADING_GAME_WORLD_PKT = 1017,

	CS_COMPLETE_LOADING_GAME_WORLD_PKT = 1018,
	SC_START_GAME_FAIL_PKT = 1019,
	SC_START_GAME_SUCCESS_PKT = 1020,

	SC_CHANGE_GAME_ROOM_STATE_PKT = 1021,
#pragma endregion
