...
bool ReferencePathTracingPass::ShouldExecute(const RenderContext* renderContext) const
{
	...
	return frameData && frameData->ready && frameData->path == RaytracingPath::Reference;
}
